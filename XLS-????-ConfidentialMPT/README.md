...
| `ZKProof`                 | Object    | Zero-knowledge proof of correctness, including:  
&emsp;(1) Well-formed encryption  
&emsp;(2) Equality of `EncryptedAmountForSender` and `EncryptedAmountForIssuer`  
&emsp;(3) `Amount` ≤ sender’s public balance  
&emsp;(4) `Amount` ≤ `MaxAmount` |
