...
- `LendingProtocolV1_1`, as described in [XLS-65.1](./65.1/README.md):
  - [65.1.1 Unmodifiable Vault Fields](./65.1/65.1.1.md): makes `Sequence`, `OwnerNode`, `Owner`, `WithdrawalPolicy`, `Scale` and `LEVersion` immutable on the Vault once set
  - [65.1.2 Vault Deletion Memo](./65.1/65.1.2.md): adds an optional `MemoData` field to `VaultDelete` that, if present, must be 1–256 bytes
...
- [XLS-65.1](./65.1/README.md): `LendingProtocolV1_1` Vault changes: [65.1.1 Unmodifiable Vault Fields](./65.1/65.1.1.md) and [65.1.2 Vault Deletion Memo](./65.1/65.1.2.md).
