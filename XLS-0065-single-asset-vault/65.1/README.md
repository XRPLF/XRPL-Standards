...
| [65.1.4 Closed-Ended Vault](./65.1.4-closed-ended-vault.md)               | Adds the `ClosedEnded` vault kind with `SubscriptionDate` and `RedemptionDate`, and phase-gates deposits and withdrawals. |
