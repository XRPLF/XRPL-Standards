...
| `float_cmp(`<br/>&emsp;`in_buf1: i32,`<br/>&emsp;`in_len1: i32,`<br/>&emsp;`in_buf2: i32,`<br/>&emsp;`in_len2: i32`<br />`)`                                                                                               | Compare two floats in xrpld format. Returns `0` if the two are equal, `1` if the first is greater than the second, and `2` if the first is less than the second. | 80       |
