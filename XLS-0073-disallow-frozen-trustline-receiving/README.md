...
- The counterparty's offers to buy or sell the tokens in the deep-frozen trustline are considered __unfunded__
...
Moreover, any existing offers where the owner has been deep-frozen on the `TakerPays` token __can no longer be consumed and will be considered as an _unfunded_ offer that will be implicitly cancelled by new Offers that cross it.__
